...
public class ObjectFactory {
    ...
    private final static QName _Operation_QNAME = new QName("http://controller/", "operation");
    private final static QName _OperationResponse_QNAME = new QName("http://controller/", "operationResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://controller/", name = "operation")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://controller/", name = "operationResponse")
